...
const propiedades = [
  ...
  {
    id: 2,
    titulo: 'Casa con jardín tropical',
    precio: 'US$ 165,000',
    tipo: 'Venta',
    habitaciones: 3,
    banos: 2,
  ...
  {
    id: 4,
    titulo: 'Local comercial zona turística',
    precio: 'US$ 2,500 / mes',
    tipo: 'Renta',
    habitaciones: 0,
    banos: 1,
    ...
    <main>
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 pb-10 w-full">
          <div className="flex items-center gap-2 text-white/60 text-sm mb-2">
            ...
            <span>/</span>
            <span className="text-white">Puerto Plata</span>
          </div>
          <h1 className="text-5xl font-black text-white">Puerto Plata</h1>
          <p className="text-white/75 mt-2">124 propiedades disponibles</p>
        </div>
      </section>
      ...
      <section className="bg-white border-b border-gray-100 sticky top-0 z-40 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-4 flex flex-wrap gap-3">
          {['Todas', 'Venta', 'Renta', 'Casas', 'Apartamentos', 'Villas', 'Terrenos', 'Locales'].map((filtro) => (
            <button
              key={filtro}
