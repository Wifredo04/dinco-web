    ...
    <section className="bg-gray-50 px-6 py-20">
      <div className="mx-auto max-w-7xl">
          ...
          {agentes.map((agente) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                <p className="mb-2 text-sm font-semibold text-[#0056B3]">
                  {agente.cargo}
                </p>
                ...
                <p className="mb-4 text-sm text-gray-400">
                  <span className="text-lg font-black text-[#0056B3]">
                    {agente.propiedades}
                  </span>{' '}
                  propiedades activas
                </p>
                ...
                <div className="flex gap-2">
                  <a
                    ...
                    className="flex flex-1 items-center justify-center gap-1.5 rounded-xl bg-green-500 py-2.5 text-xs font-bold text-white transition-colors duration-300 hover:bg-green-600"
                  >
                    <svg
                      className="h-4 w-4"
                      fill="currentColor"
                  ...
                  <a
                    ...
                    className="flex flex-1 items-center justify-center gap-1.5 rounded-xl bg-[#0056B3] py-2.5 text-xs font-bold text-white transition-colors duration-300 hover:bg-[#003d82]"
                  >
                    <svg
                      className="h-4 w-4"
                      fill="none"
        ...
        <div className="mt-12 text-center">
          <Link
            href="/agentes"
            className="inline-flex items-center gap-2 rounded-xl bg-[#0056B3] px-8 py-4 font-bold text-white shadow-lg transition-all duration-300 hover:bg-[#FF2A39] hover:shadow-xl"
          >
