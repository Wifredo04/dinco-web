      ...
      <div className="bg-[#FF2A39] py-12 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            ...
            <p className="text-white/75">Suscríbete y sé el primero en conocer las mejores oportunidades</p>
          </div>
      ...
      <div className="py-16 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Puerto Plata', 'Cabarete', 'Sosúa', 'Santo Domingo', 'Samaná', 'Monte Cristi'].map((item) => (
                <li key={item}>
                  <Link href="#" className="text-white/60 hover:text-[#FF2A39] text-sm transition-colors duration-200">
                    {item}
                  </Link>
          ...
          <div>
            ...
            <ul className="space-y-4">
              {[
                { icon: 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z', texto: 'Puerto Plata, República Dominicana' },
            ...
            <div className="mt-6">
              <h5 className="font-bold text-sm mb-3">Horario de atención</h5>
              <p className="text-white/60 text-sm">Lunes a Viernes: 8am - 6pm</p>
              <p className="text-white/60 text-sm">Sábados: 9am - 2pm</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-white/10 py-6 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-white/40 text-sm">
            © 2025 DINCO Inmobiliaria & Constructora. Todos los derechos reservados.
          </p>
